...
int main() {
  ...
  char buffer[MAXBUFFERLEN]; // Tampon de communication entre le client et le
                             // serveur
  ...
  hints.ai_family = AF_UNSPEC; // les adresses IPv4 et IPv6 seront présentées
                               // par la fonction getaddrinfo
